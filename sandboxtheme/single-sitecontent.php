         ...
         <div class="row">
             ...
             <div class="col-md-12">
                 ...
                 <div class="downloadarea">
                     ...
                     <p>Click <a href="<?php the_field('sc_download'); ?>" target="_blank">here</a> for the most recent PRINTABLE version of your website content.</p>
                 </div>
                     ...
                     <?php
                        //combine previous revisions values with new revisions values, push them all to db
                        ...
                        //step 2: grab the current user data
